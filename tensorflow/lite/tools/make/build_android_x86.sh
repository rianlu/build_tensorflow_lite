...
export ndk_standalone_root="/Users/lu/Development/android_toolchains/x86-android-toolchain"
export EXTRA_CXXFLAGS="-isysroot=${ndk_standalone_root}/sysroot"
export CC_PREFIX=${ndk_standalone_root}/bin/

make -j ${NO_JOB} TARGET=android_x86 -C "${TENSORFLOW_DIR}" -f tensorflow/lite/tools/make/Makefile.android $@
